#!/usr/bin/env bash
#
# preflight-check.sh — local 8-gate runner.
#
...
# (## Preflight section) per the preflight protocol.
...
# Keep this set in sync. The previous 3 entries were cleared (Symfony 7.4
...
# ── Gate 9: Honeypot-name leak scan ─────────────────────────
CURRENT_GATE=9
