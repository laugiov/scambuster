...
against OpenCTI** -- see the [OpenCTI Integration guide](docs/11_opencti_integration.md)
...
| [OpenCTI Integration](docs/11_opencti_integration.md) | Wire OpenCTI to the feed: what lands where, and the traps |
