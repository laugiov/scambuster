...
export const STIMULUS_COLORS: Record<string, string> = {
  URGENCY_PRESSURE: 'bg-warning/20 text-warning',
  AUTHORITY: 'bg-purple-500/20 text-purple-400',
  RECIPROCITY: 'bg-blue-500/20 text-blue-400',
  FINANCIAL_INCENTIVE: 'bg-success/20 text-success',
  SCARCITY: 'bg-warning/20 text-warning',
  SOCIAL_PROOF: 'bg-blue-500/20 text-blue-400',
  PASSIVE: 'bg-on-surface-dim/20 text-on-surface-dim',
};
