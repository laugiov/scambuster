...
describe('ENDPOINTS', () => {
  ...
  describe('clusters', () => {
    ...
    it('has correct temporal function', () => {
      expect(ENDPOINTS.clusters.temporal('cl-1')).toBe('/clusters/cl-1/temporal');
    });

    it('has correct abuseReport function', () => {
      expect(ENDPOINTS.clusters.abuseReport('cl-1')).toBe('/clusters/cl-1/abuse-report');
    });
  });
