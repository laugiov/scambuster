...
function DominanceChart({ entries, config, selectedScamType, onScamTypeChange }: {
  ...
  // Convergence threshold (% dominance) read from bandit
  ...
  return (
    <div className="bg-surface-low rounded-lg p-5 space-y-4">
      ...
      {/* Current state line, always visible,
      ...
      {chartData.length < 2 ? (
        ...
        <ResponsiveContainer width="100%" height={250}>
          <LineChart data={chartData}>
            ...
            />
            {/* Horizontal reference line at the convergence
      ...
      {/* Caption explaining the multi-color
