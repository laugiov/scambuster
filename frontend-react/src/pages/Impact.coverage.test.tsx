...
const mockImpactWithTrends = {
  wasted_time: {
    ...
    // Scammer Replies Elicited tile fixture.
  ...
  ioc_value: {
    novel_pct: 68.8,
    novel_iocs: 198,
    // dual-face tile fields (Total face when window_days=null)
    total_iocs: 1700,
...
describe('Impact — coverage gaps', () => {
  ...
  it('renders trend deltas (up/down arrows)', async () => {
    ...
    // the old novel_pct_delta "pp" chip was retired when the
  ...
  it('renders weekly wasted chart with empty data', async () => {
    setupHandlers({
      ...
      wasted_time: {
        ...
        weekly_trend: [],
        // Scammer Replies tile fields required even when chart is empty
