...
export function Impact() {
  ...
  // page-level scam_type filter. Empty string = no filter (All).
    ...
    <div className="space-y-6">
      <header className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {/* page-level scam_type filter, drives all 5 widgets */}
          <select
      ...
      {/* Scammer engagement card, driven by page-level filters */}
