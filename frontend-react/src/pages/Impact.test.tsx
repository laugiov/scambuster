...
const mockImpactSummary = {
  wasted_time: {
    ...
    // Scammer Replies Elicited tile (windowed period fixture)
...
describe('Impact page', () => {
  ...
  it('renders stat cards (Fresh IOCs face when window applies)', async () => {
    ...
    // Engagement Time → Scammer Replies Elicited
    ...
    // Novel IOCs tile replaced by Fresh IOCs (last Nd)
  ...
  it('renders Actor Deduplication card', async () => {
    render(<Impact />, { wrapper: createWrapper() });
