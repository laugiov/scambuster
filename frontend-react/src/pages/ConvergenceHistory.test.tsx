...
describe('ConvergenceHistory', () => {
  ...
  // Convergence state banner above the dominance chart.
  ...
  it('renders one of the three current-state convergence banners', async () => {
    setupHandlers();
    render(<ConvergenceHistory />, { wrapper: createWrapper() });
    await waitFor(() => {
  ...
  it('"currently dominant" line always renders when data exists', async () => {
    setupHandlers();
    render(<ConvergenceHistory />, { wrapper: createWrapper() });
    await waitFor(() => {
