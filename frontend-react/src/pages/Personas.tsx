...
export function Personas() {
  ...
  // min-session gate on the headline KPI.
    ...
    <div className="space-y-6">
      <header className="flex items-start justify-between">
        ...
        <button
          ...
          className="text-xs px-3 py-1.5 rounded bg-accent text-surface-base font-medium hover:opacity-90"
        >
          {t('personas.create.addButton', '+ Add persona')}
        </button>
      </header>
