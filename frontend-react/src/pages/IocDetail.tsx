...
export function IocDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* IOC → TTP pivot: TTPs co-observed with this indicator */}
      {indicatorId && <IocCoOccurringTtps indicatorId={indicatorId} />}
  ...
  return (
    <div className="bg-surface-low rounded-lg overflow-hidden">
      ...
      <div className="p-5 space-y-4">
        ...
        {/* CTI standards — surfaced for SOC/CERT consumers. The
            upstream classifier already populates scam_type_attck +
            scam_type_misp; previously not displayed. */}
