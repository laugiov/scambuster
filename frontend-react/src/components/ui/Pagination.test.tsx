...
describe('Pagination', () => {
  ...
  it('labels the previous and next buttons for screen readers', () => {
    render(<Pagination page={2} pageSize={10} totalItems={30} onPageChange={vi.fn()} />);
    // The previous button once carried t('common.retry') by mistake — pin the
    // dedicated navigation labels on both icon-only buttons.
