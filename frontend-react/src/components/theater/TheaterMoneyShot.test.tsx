...
describe('TheaterMoneyShot — pinned financial banner', () => {
  // Fixtures use 1-based idx, matching the backend
  ...
  // Regression: the ratio must reflect the actual
  // message position in the conversation. Backend serialises `idx`
  // as 1-based (1..N); the frontend must not add another +1 on top.
  it('computes ratio correctly when financial reveals before the last message', () => {
