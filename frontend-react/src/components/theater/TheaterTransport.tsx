...
/**
 * A chapter marker is a single point on the progress bar
  ...
  return (
    <div className="border-t border-outline-variant bg-surface-low px-6 py-3 flex items-center gap-3 shrink-0">
      ...
      >
        ...
        {/* Chapter markers (clickable, scrub on click).
            Visually differentiated per kind so the
...
/**
 * Size + offset per marker kind. Financial = tall +
