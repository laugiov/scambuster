...
const NAV_ENTRIES: NavEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        labelKey: 'nav.pipelineMonitor',
        path: '/monitoring/pipeline',
        icon: 'M13 10V3L4 14h7v7l9-11h-7z',
      },
      {
        labelKey: 'nav.injectionMonitor',
        path: '/monitoring/injection',
        icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z',
      },
      {
        labelKey: 'nav.llmCosts',
        path: '/llm-costs',
...
export function Sidebar() {
  ...
  return (
    <aside
      className="fixed top-0 left-0 h-screen w-[var(--spacing-sidebar)] bg-sidebar flex flex-col z-50"
      role="navigation"
    ...
    >
      <div className="px-5 py-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-on-surface-dim uppercase tracking-widest mt-0.5">
            {t('nav.subtitle')}
          </p>
        </div>
      </div>
