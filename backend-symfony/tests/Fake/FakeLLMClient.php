...
DSL;
        ...
        // Check if this is a TTP extraction prompt. One item above and one below
        // the default 0.55 confidence threshold so functional tests can assert
        // both the 'confirmed' and the 'review' status paths.
