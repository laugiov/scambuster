...
final class IocControllerValidationTest extends WebTestCase
{
    ...
    {
        // Regression: the outgoing-message guard must not break legitimate enriched-IOC ingestion on incoming messages.
        $payload = [
        ...
        $this->assertNotSame(Response::HTTP_BAD_REQUEST, $statusCode, sprintf(
            'Incoming message must not be rejected by the outgoing-message guard, got status %d: %s',
            $statusCode,
