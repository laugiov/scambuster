...
final class ConversationStixExportWithActorTest extends WebTestCase
{
    ...
    public function testThreatActorHasCorrectFields(): void
    {
        ...
        $this->assertArrayHasKey(\App\Application\Stix\ScambusterStixExtensions::ACTOR_ID, $actor['extensions']);
    }

    // ------------------------------------------------------------------ //
    //  Cognitive Mirror Note SDO attached to threat-actor
    // ------------------------------------------------------------------ //
    ...
    public function testExportIncludesCognitiveMirrorNoteWhenMirrorIsCached(): void
    {
        ...
        $conn->executeStatement(
            ...
            [
                $row['persona_id'],
                $row['scam_type_id'],
                'Test profile for actor export (P3)',
        ...
        $this->assertNotNull($note, 'a Cognitive Mirror Note must be attached when a mirror is cached.');
    ...
    // ------------------------------------------------------------------ //
    //  JSON schema validation on the live export response
    // ------------------------------------------------------------------ //
    ...
    public function testExportedBundleValidatesAgainstStixExtensionSchemas(): void
    {
        ...
        $conn->executeStatement(
            ...
            [
                $row['persona_id'],
                $row['scam_type_id'],
                'Test profile for actor export (P6)',
