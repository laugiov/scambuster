...
trait EndToEndJwtTrait
{
    ...
    {
        return $this->loginAndGetToken($client, 'user@example.com');
    }

    private function getValidAdminJwt(KernelBrowser $client): string
    {
        return $this->loginAndGetToken($client, 'admin@example.com');
    }
