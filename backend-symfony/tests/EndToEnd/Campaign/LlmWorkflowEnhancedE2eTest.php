...
/**
 * Tests E2E RENFORCÉS pour Campaign Radar Phase 3: LLM Services
 *
 * @group endtoend
 *
 * Couvre:
 * - Workflow complet Profile → Compile avec FakeLLMClient
 * - Validation erreurs (< 3 messages, campaign inexistante)
 * - Messages retrieval (GET /campaign/{id}/messages)
 * - Persistence profile_yaml en DB
 * - Edge cases (sample_limit, messages vides, unicode)
 * - Scénarios réalistes (PayPal, banques)
 * - Performance (latence < 30s)
 */
