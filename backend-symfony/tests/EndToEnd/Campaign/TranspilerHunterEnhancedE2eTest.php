...
/**
 * Enhanced E2E tests for Transpiler & Hunter
 *
 * Covers:
 * - Complete realistic scenarios (PayPal, bank, crypto, Amazon)
 * - Full workflow: transpile → store → hunt → verify
 * - PPV calculation with realistic messages (high/low risk)
 * - Lead-time calculation with time series
 * - Metrics persistence
