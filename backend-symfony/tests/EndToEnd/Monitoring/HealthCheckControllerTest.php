...
use App\Tests\EndToEnd\EndToEndJwtTrait;
...
final class HealthCheckControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // /api/health is admin-only; authenticate every request as admin.
        $this->client->setServerParameter('HTTP_AUTHORIZATION', 'Bearer ' . $this->getValidAdminJwt($this->client));
    }
