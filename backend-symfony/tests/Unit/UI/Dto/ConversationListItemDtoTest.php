...
class ConversationListItemDtoTest extends TestCase
{
    ...
    public function testAccountFieldsPopulatedWhenProvided(): void
    {
        ...
        $this->assertSame('Tarrowby Holdings', $dto->account_label);
        $this->assertSame('admin@tarrowbyholdings.com', $dto->account_email);

        $array = $dto->toArray();
        $this->assertSame('Tarrowby Holdings', $array['account_label']);
        $this->assertSame('admin@tarrowbyholdings.com', $array['account_email']);
    }
}
