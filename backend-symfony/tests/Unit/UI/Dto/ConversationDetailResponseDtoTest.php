...
class ConversationDetailResponseDtoTest extends TestCase
{
    ...
    public function testAccountFieldsPopulatedWhenProvided(): void
    {
        ...
        $this->assertSame('Calverton Partners', $dto->account_label);
        $this->assertSame('admin@calvertonpartners.com', $dto->account_email);

        $array = $dto->toArray();
        $this->assertSame('Calverton Partners', $array['account_label']);
        $this->assertSame('admin@calvertonpartners.com', $array['account_email']);
    }
}
