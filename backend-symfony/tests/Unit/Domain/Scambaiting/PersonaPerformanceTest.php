...
final class PersonaPerformanceTest extends TestCase
{
    ...
    {
        // backward compat: the new ctor parameter has a
    ...
    {
        // reproduces the math: hopeless_romantic
        ...
        // Within tolerance of the predicted value.
    ...
    {
        // cold start is a "no learning signal" gate. A
    ...
    {
        // invariant — withNewReward() only updates the
