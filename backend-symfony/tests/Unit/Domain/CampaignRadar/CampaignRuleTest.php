...
final class CampaignRuleTest extends TestCase
{
    ...
    public function testSetCompiledSqlStoresSql(): void
    {
        ...
        // Verify the SQL is stored in the compiledData structure
    ...
    {
        $rule = new CampaignRule($this->campaignId, 'RULE test {}');
        $rule->updateMetrics(10, 8, 2); // 10 hits, 8 true positives, 2 false positives
    ...
    {
        $rule = new CampaignRule($this->campaignId, 'RULE test {}');
        $rule->updateMetrics(10, 6, 4); // PPV = 0.6 (too low)
