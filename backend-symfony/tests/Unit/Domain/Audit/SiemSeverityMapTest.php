...
class SiemSeverityMapTest extends TestCase
{
    ...
    public static function severityProvider(): iterable
    {
        ...
        yield 'AUTH_TOKEN_REFRESHED is low (routine rotation)' => [AuditEventType::AUTH_TOKEN_REFRESHED, 2];
        yield 'AUTH_TOKEN_REUSE_DETECTED is high (theft signal)' => [AuditEventType::AUTH_TOKEN_REUSE_DETECTED, 8];
    }
    ...
    public static function ecsCategoryProvider(): iterable
    {
        ...
        yield 'AUTH_TOKEN_REFRESHED => authentication' => [AuditEventType::AUTH_TOKEN_REFRESHED, 'authentication'];
        yield 'AUTH_TOKEN_REUSE_DETECTED => authentication' => [AuditEventType::AUTH_TOKEN_REUSE_DETECTED, 'authentication'];
