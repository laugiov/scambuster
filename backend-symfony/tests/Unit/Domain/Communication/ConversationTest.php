...
class ConversationTest extends TestCase
{
    ...
    public function test_it_sets_and_gets_tlp_level(): void
    {
        ...
        $conversation->setTlp('TLP_AMBER_STRICT');
        $this->assertSame('TLP_AMBER_STRICT', $conversation->getTlp());
    ...
    public function test_soft_delete_stamps_the_deletion_time(): void
    {
        $conversation = $this->createTestConversation();
        self::assertNull($conversation->getDeletedAt());

        $at = new \DateTimeImmutable('2026-07-06 10:00:00');
        $conversation->softDelete($at);

        self::assertSame($at, $conversation->getDeletedAt());
    }
}
