...
class ClusteredThreatActorStixBuilderTest extends TestCase
{
    ...
    // ============================================================================
    // buildThreatActorObjects() for embeddable use
    // ============================================================================
    //
    ...
    public function testBuildThreatActorObjectsHonoursClusterTypeConsolidatedExtension(): void
    {
        ...
        $ext = $result['threat_actor']['extensions'][\App\Application\Stix\ScambusterStixExtensions::ACTOR_ID]['x_scambuster_actor'] ?? null;
