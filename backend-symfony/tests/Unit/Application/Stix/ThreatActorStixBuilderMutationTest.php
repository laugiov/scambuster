...
final class ThreatActorStixBuilderMutationTest extends TestCase
{
    ...
    {
        $result = $this->build([]);
        self::assertSame('1.0', $result['extensions']['x_scambuster_actor']['schema_version']);
    }

    public function testExtensionCampaignId(): void
    {
        $result = $this->build(['campaign_id' => 'test-campaign-abc']);
        self::assertSame('test-campaign-abc', $result['extensions']['x_scambuster_actor']['campaign_id']);
    }

    public function testExtensionScamType(): void
    {
        $result = $this->build(['scam_type' => 'LOTTERY']);
        self::assertSame('LOTTERY', $result['extensions']['x_scambuster_actor']['scam_type']);
    }

    public function testExtensionConversationCount(): void
    {
        $result = $this->build([], null, ['conversation_count' => 42]);
        self::assertSame(42, $result['extensions']['x_scambuster_actor']['conversation_count']);
    }

    public function testExtensionConversationCountDefaultZero(): void
    {
        $result = $this->build([]);
        self::assertSame(0, $result['extensions']['x_scambuster_actor']['conversation_count']);
    }
    ...
    public function testExtensionStyleDnaPresent(): void
    {
        ...
        self::assertSame(['avg_len' => 12], $result['extensions']['x_scambuster_actor']['style_dna']);
    }
    ...
    public function testExtensionInfraDnaPresent(): void
    {
        ...
        $result = $this->build([], $profile);
        self::assertSame(['unique_domains' => ['evil.com']], $result['extensions']['x_scambuster_actor']['infra_dna']);
    }

    public function testExtensionNoDnaWithoutProfile(): void
    {
        $result = $this->build([], null);
        self::assertArrayNotHasKey('style_dna', $result['extensions']['x_scambuster_actor']);
        self::assertArrayNotHasKey('infra_dna', $result['extensions']['x_scambuster_actor']);
    }
