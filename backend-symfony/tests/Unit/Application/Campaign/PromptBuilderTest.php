...
final class PromptBuilderTest extends TestCase
{
    ...
    /**
     * Campaign profiler prompt must now be in English
     * (was French previously). Eliminates LLM code-switching.
     */
    public function testCampaignProfilerPromptIsInEnglish(): void
    {
    ...
    /**
     * Rule compiler prompt must now be in English
     * (was French previously).
     */
    public function testRuleCompilerPromptIsInEnglish(): void
    {
