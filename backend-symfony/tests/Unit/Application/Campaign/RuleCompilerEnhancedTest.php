...
/**
 * Tests unitaires RENFORCÉS pour RuleCompiler
 *
 * Couvre:
 * - DSL validation complète (syntaxe, champs, opérateurs)
 * - Retry logic (timeout, erreurs, backoff)
 * - Extraction DSL (markdown, formats multiples)
 * - Rule counting (1-3 règles)
 * - Test generation (positive/negative examples)
 * - Edge cases (DSL complexe, invalid syntax)
