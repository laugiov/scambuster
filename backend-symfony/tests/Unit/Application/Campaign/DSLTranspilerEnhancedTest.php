...
/**
 * Reinforced unit tests for DSLTranspiler
 *
 * Covers:
 * - All predicate types (6 types)
 * - Multiple combinations (AND)
 * - Edge cases (extreme values, unicode, special characters)
 * - DSL syntax validation (missing WHERE/ACTION)
 * - SQL injection security (prepared statements)
 * - Realistic scenarios (PayPal, banks, cryptos)
