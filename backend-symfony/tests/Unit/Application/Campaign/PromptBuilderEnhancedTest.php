...
/**
 * Reinforced unit tests for PromptBuilder
 *
 * Covers:
 * - Edge cases (empty texts, null, very long, special characters)
 * - Security (PII masking, URL defanging, XSS)
 * - Validation (min messages, prompt format)
 * - Realistic scenarios (PayPal phishing, banks, etc.)
 */
final class PromptBuilderEnhancedTest extends TestCase
{
    ...
    public function testMasksPhoneNumbersFrench(): void
    {
        ...
        // French phone numbers must be masked
        ...
        $this->assertStringContainsString('***', $prompts['user']); // Masking pattern
    }
    ...
    public function testMasksPhoneNumbersInternational(): void
    {
        ...
        // International phone numbers must be masked
    ...
    // ==================== Reinforced URL Defanging Tests ====================
    ...
    public function testDefangsUrlsWithDifferentSchemes(): void
    {
        ...
        // FTP should also be defanged if implemented
    }
    ...
    public function testDefangsUrlsInSubjectAndBody(): void
    {
        ...
        // URLs in body are defanged (subject not - by current design)
        $this->assertStringContainsString('hxxps://body-url.net', $prompts['user']);

        // Note: Subject URLs are not defanged currently
        // See PromptBuilder.php line 66 - subject displayed as-is
    }
    ...
    public function testHandlesVeryLongMessages(): void
    {
        ...
        // Prompt must be truncated but valid
    ...
    public function testHandlesEmptySubjectAndBody(): void
    {
        ...
        // Must return a valid prompt even with empty text
    ...
    public function testHandlesMissingAuthHeaders(): void
    {
        ...
        // Must display "absent" if headers missing (see PromptBuilder.php:232)
        $this->assertStringContainsString('DKIM: absent', $prompts['user']);
    }

    // ==================== RuleCompiler Prompts Tests ====================
    ...
    public function testPayPalPhishingScenario(): void
    {
        ...
        // Verify DKIM (SPF not yet implemented)
    ...
    public function testBankPhishingScenario(): void
    {
        ...
        // URLs defanged (currently implemented)
        ...
        // Phone and IBAN masking: not yet implemented (see @group future tests)
    ...
    public function testHandlesXSSInSubject(): void
    {
        ...
        // XSS must be preserved (no server-side execution) but visible in prompt
    ...
    public function testHandlesSQLInjectionInBody(): void
    {
        ...
        // SQL injection must be preserved in the prompt (for LLM analysis)
