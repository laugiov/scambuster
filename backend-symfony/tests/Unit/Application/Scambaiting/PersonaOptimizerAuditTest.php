...
/**
 * verify PersonaOptimizer emits BANDIT_DECISION audit
...
final class PersonaOptimizerAuditTest extends TestCase
{
    ...
    public function testBanditDecisionEmittedOnColdStartBranch(): void
    {
    ...
    public function testBanditDecisionEmittedOnExploitationBranch(): void
    {
    ...
    public function testBanditDecisionEmittedOnExplorationBranch(): void
    {
    ...
    public function testBanditDecisionAndPersonaSelectedBothFire(): void
    {
        ...
        $this->assertCount(1, $banditDecision, 'New BANDIT_DECISION must also fire');
