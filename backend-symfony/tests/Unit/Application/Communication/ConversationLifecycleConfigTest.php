...
class ConversationLifecycleConfigTest extends TestCase
{
    ...
    public function testUnknownUsesDefaultPolicy(): void
    {
        ...
        // UNKNOWN bucket now allows reopen to recover
    ...
    public function testReopenDeniedOnlyForLowValueScams(): void
    {
        // Only LOTTERY + CHARITY still deny reopen
    ...
    public function testReopenAllowedForShortScams(): void
    {
        // Short-window scam types that previously denied
        ...
        foreach (['PHISHING', 'PHISH_CREDENTIALS', 'PHISH_MALWARE', 'TECH_SUPPORT', 'CEO_FRAUD', 'JOB_OFFER', 'INVOICE_FRAUD', 'UNKNOWN'] as $type) {
            $this->assertTrue(ConversationLifecycleConfig::allowsReopen($type), "$type should allow reopen");
