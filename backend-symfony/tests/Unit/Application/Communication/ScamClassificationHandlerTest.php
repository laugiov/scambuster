...
class ScamClassificationHandlerTest extends TestCase
{
    ...
    // === SCAM_CLASSIFIED audit emission ===

    /**
     * The constructor accepts an optional AuditLogger as
     ...
     * is covered end-to-end by the test_cases.sh against the live
     * pipeline, since unit-mocking the Doctrine QueryBuilder used in
     * getConversationMessages is brittle).
     */
    public function testHandlerCtorAcceptsOptionalAuditLogger(): void
    {
        $auditLogger = new AuditLogger(
            $this->createMock(EntityManagerInterface::class),
            new NullLogger(),
            new \App\Tests\Support\Audit\NullRequestContext(),
