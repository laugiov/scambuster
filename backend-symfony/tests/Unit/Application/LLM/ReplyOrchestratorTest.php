...
class ReplyOrchestratorTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // iocThreshold set to 0 in this test fixture because
        ...
        // RetryCoordinatorTest::test_low_ioc_score_triggers_retry.
        $this->orchestrator = new ReplyOrchestrator(
            ...
            iocThreshold: 0, // disable IOC threshold for legacy flow tests
    ...
    public function it_generates_approved_reply(): void
    {
        ...
        // Validator response now also exposes the per-axis
