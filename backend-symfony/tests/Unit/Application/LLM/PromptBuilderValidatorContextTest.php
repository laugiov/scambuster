...
/**
 * Verify the validator prompt extensions:
 ...
 * convention — assertions kept inline).
 */
final class PromptBuilderValidatorContextTest extends TestCase
{
    ...
    public function test_identity_coherence_check_block_appears_with_four_conditions(): void
    {
        ...
        // 4 condition lines — each contains its discriminative substring.
    ...
    // ─── role coherence + honeypot identity ──────────────────

    public function test_honeypot_email_appears_in_context_block_when_provided(): void
    {
        $context = [
            'inbound_text' => 'hello',
    ...
    public function test_role_coherence_directives_appear_in_identity_block(): void
    {
        $context = [
            'inbound_text' => 'hello',
            'inbound_from' => 'scammer@evil.example',
    ...
    public function test_role_inversion_is_a_system_prompt_security_gate_failure(): void
    {
    ...
    public function test_block_renders_even_when_honeypot_email_missing(): void
    {
