...
final class SignatureStripperTest extends TestCase
{
    private function newStripper(bool $enabled = true): SignatureStripper
    {
        ...
        $auditLogger = new AuditLogger(
            ...
            requestContext: new \App\Tests\Support\Audit\NullRequestContext(),
    ...
    {
        // 22 cases across 6 non-English languages, matching the
    ...
    /**
     * Feature flag `REPLY_SIGNATURE_STRIP_ENABLED` short-circuit.
