...
/**
 * Spec 095 Fix #13 — verify RetryCoordinator emits REPLY_RETRY on
...
final class RetryCoordinatorAuditTest extends TestCase
{
    ...
    public function testReplyRetryEmittedWhenPolicyGuardRejectsAttempt1_Fix13(): void
    {
    ...
    public function testReplyRetryHelperPopulatesIocThresholdPayload_Fix13(): void
    {
        ...
        // end-to-end by the Fix #13 test_cases.sh, where the live IOCScorer
    ...
    public function testReplyRetryEmittedWhenValidatorRejects_Fix13(): void
    {
    ...
    public function testReplyRejectedEmittedWhenPolicyGuardExhausts_Fix13(): void
    {
    ...
    public function testNoRejectedEmissionWhenReplyIsApproved_Fix13(): void
    {
