...
/**
 * Spec 075a (original): urgency few-shot calibration coverage.
 * Spec 102 / Phase E-S5 (current): the 10-example "Calibration examples"
...
final class UrgencyFewShotTest extends TestCase
{
    ...
    {
        // v2 anchors — sparser than the 10-example format from Spec 075a,
