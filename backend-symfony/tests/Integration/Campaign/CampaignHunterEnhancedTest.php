...
/**
 * Enhanced integration tests for CampaignHunter
 *
 * Covers:
 * - Execution with prepared SQL (prepared statements)
 * - PPV calculation (true_pos / total)
 * - Lead-time calculation with peaks
...
final class CampaignHunterEnhancedTest extends KernelTestCase
{
    ...
    public function testHuntHandlesInvalidJson(): void
    {
        ...
        $property->setValue($rule, ['invalid' => 'structure']); // No 'sql' key
