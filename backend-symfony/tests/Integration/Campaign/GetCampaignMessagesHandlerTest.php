...
class GetCampaignMessagesHandlerTest extends KernelTestCase
{
    ...
    {
        // Créer une campagne sans messages
    ...
    {
        // Créer campagne avec 3 messages
        ...
        // Vérifier structure d'un message
    ...
    {
        // Créer campagne avec 10 messages
        $campaignId = $this->createCampaignWithMessages(10);

        // Demander seulement 3 messages
    ...
    {
        // Créer message avec body > 200 chars
    ...
    {
        // Créer 3 messages avec timestamps différents
        $campaign = new Campaign('test-integration');
        $this->em->persist($campaign);
        $this->em->flush();
        ...
        // Les messages doivent être dans l'ordre DESC (le dernier créé en premier)
        $this->assertEquals(3, $result['messages_count']);
