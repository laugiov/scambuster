...
class ProfileCampaignHandlerTest extends KernelTestCase
{
    ...
    {
        // Create a campaign with only 2 messages
    ...
    {
        // Create a campaign with 5 messages
        ...
        // FakeLLMClient returns generic text, not valid YAML
        // But the handler stores the result anyway
    ...
    {
        // Create campaign with 20 messages
    ...
    private function createCampaignWithMessages(int $count): string
    {
        ...
        // Create N messages and assign them to the campaign
        for ($i = 0; $i < $count; $i++) {
