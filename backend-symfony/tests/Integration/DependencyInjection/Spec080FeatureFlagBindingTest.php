...
/**
 * Spec 080 — verify that the 4 feature-flag parameters are defined,
 * resolved from their corresponding env vars, and bound as autowire
 * scalars in the DI container.
 *
 * This test is the Red side of T02 (Red→Green TDD cycle): it asserts
 ...
 */
final class Spec080FeatureFlagBindingTest extends KernelTestCase
{
    /**
