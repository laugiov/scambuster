...
class ConversationHistoryServiceTest extends KernelTestCase
{
    ...
    /**
     * ConversationHistoryService::generateSummary's
     * system+user prompt must now be in English (was French previously).
     * Eliminates LLM code-switching with the 90 % EN corpus.
     */
    public function testGenerateSummaryPromptIsInEnglish(): void
    {
