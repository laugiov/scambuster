 ...
 *
 * If this test ever fails, it means a regression has reintroduced the
 * original bug: somewhere in the codebase IOCs are being extracted out of
...
final class NoIocFromOutgoingMessageTest extends KernelTestCase
{
    public function testNoObservedIocReferencesOutgoingMessage(): void
    {
        ...
        $this->assertSame(
            ...
            $count,
            sprintf(
                'Found %d observed_ioc rows linked to outgoing messages — regression. '
