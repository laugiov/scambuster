...
final class IocUpsertServiceHoneypotFilterTest extends KernelTestCase
{
    ...
    // ─────────────────────────────────────────────────────────────────────
    // DOMAIN + URL filter extension
    //
    // Previously, the filter only matched type='email'. Now, any
    ...
    {
        // IocCategorizer stores value_norm in defanged form
    ...
    {
        // A URL like `www.example.com/x` without an
