...
/**
 * Spec 081 — Conversation alternation invariant.
 *
...
class AlternationInvariantTest extends KernelTestCase
{
    ...
    /** Spec 081 — FR-001, FR-002, AC1.2: latest message is outbound → suppress + return existing data. */
    ...
    /** Spec 081 — FR-004 + AC1.3: force=true does NOT bypass the alternation invariant. */
    ...
    /** Spec 081 — AC1.1: latest is inbound → generation proceeds normally. */
    ...
    /**
     * Spec 081 — FR-008 + Edge case: latest by ts_msg is a soft-deleted outbound.
    ...
    /**
     * Spec 081 — Realistic alternation sequence:
    ...
    /** Spec 081 — FR-002: response shape on suppression mirrors a normal success. */
