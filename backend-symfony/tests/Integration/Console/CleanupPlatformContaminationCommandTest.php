...
/**
 * Cleanup command integration test.
 *
...
final class CleanupPlatformContaminationCommandTest extends KernelTestCase
{
    ...
    private function seedContaminatedFixture(): void
    {
        ...
        // NOTE: must NOT be on the honeypot domain (emails under a
        ...
        // Indicator E: honeypot DOMAIN observed on incoming msg
        ...
        // Indicator F: honeypot URL with www. prefix.
        ...
        // Indicator G: typo-squat domain (NOT honeypot).
        // MUST survive.
    ...
    {
        // Honeypot DOMAINS are now EXPLICIT (not derived from
