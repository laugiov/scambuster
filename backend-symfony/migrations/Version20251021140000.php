 ...
 * Creates the campaign, campaign_rule, message_campaign, actor_profile tables + SQL views
 */
final class Version20251021140000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN campaign.profile_yaml IS \'YAML profile generated by LLM (CampaignProfiler)\'');
        $this->addSql('COMMENT ON COLUMN campaign.centroid_simhash IS \'Simhash MD5 centroid for clustering similarity\'');
        ...
        $this->addSql('COMMENT ON COLUMN message_campaign.is_true_positive IS \'True=TP, False=FP, Null=not validated\'');
        ...
        // View for metrics: shadow hits per campaign
        $this->addSql('
        ...
        // View for PPV drift detection (7-day sliding window)
        $this->addSql('
