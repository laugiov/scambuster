...
/**
 * Spec 065e — Encrypt existing TOTP secrets at rest using libsodium.
 *
...
final class Version2026041200000000 extends AbstractMigration
{
    ...
    {
        return 'Spec 065e — Change totp_secret from VARCHAR(255) to BYTEA + encrypt existing values';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        if (!is_string($hexKey) || strlen($hexKey) !== 64 || !ctype_xdigit($hexKey)) {
            throw new \RuntimeException(
                'Spec 065e migration requires TOTP_ENCRYPTION_KEY env var (64 hex chars). '
    ...
    public function down(Schema $schema): void
    {
        throw new IrreversibleMigration(
            'Spec 065e — reverting TOTP encryption would re-introduce the H2 finding '
