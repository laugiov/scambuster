...
/**
 * Spec 104 P3 — persona_scam_mirror table.
 *
...
final class Version2026061500000000 extends AbstractMigration
{
    ...
    {
        return 'Spec 104 P3 — persona_scam_mirror table for the cognitive mirror cache';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            COMMENT ON TABLE persona_scam_mirror IS 'Spec 104 P3 — LLM-generated cognitive mirror text per persona x scam type pair'
        SQL);
