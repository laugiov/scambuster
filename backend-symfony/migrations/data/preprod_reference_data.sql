-- Données de référence pour environnement preprod
-- Exécuté après les migrations pour initialiser les tables lookup et personas
...
-- 5. USERS (app_users)
-- ==============================================================================
-- Note: Le mot de passe "Un1que$trongPassword2024" est haché avec bcrypt
-- Hash généré: $2y$13$OU8EH4HxhGGdLQpJ2.KzN.GBMrANpKvIXvT3fMKQW6Z9.YC7XH.9K
TRUNCATE TABLE app_users CASCADE;

-- Admin user pour preprod
