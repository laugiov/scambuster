...
-- Invoice scams (fausse facture) - Business personas
INSERT INTO scam_type_persona (scam_type_id, persona_id)
VALUES
    (6, 7);   -- small_business_owner

-- Phishing (hameçonnage) - Banking/Tech personas
INSERT INTO scam_type_persona (scam_type_id, persona_id)
VALUES
    (2, 3);   -- bank_customer

-- Lottery (arnaque à la loterie) - Gullible personas
INSERT INTO scam_type_persona (scam_type_id, persona_id)
VALUES
    (3, 4);   -- elderly_person

-- Romance scams (arnaque sentimentale) - Lonely personas
INSERT INTO scam_type_persona (scam_type_id, persona_id)
VALUES
    (4, 5);   -- lonely_person
