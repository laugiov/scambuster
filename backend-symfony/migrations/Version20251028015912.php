...
final class Version20251028015912 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            COMMENT ON COLUMN message_campaign.is_true_positive IS 'True=TP, False=FP, Null=not validated'
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            COMMENT ON COLUMN campaign.profile_yaml IS 'YAML profile generated by LLM (CampaignProfiler)'
        SQL);
        $this->addSql(<<<'SQL'
            COMMENT ON COLUMN campaign.centroid_simhash IS 'Simhash MD5 centroid for clustering similarity'
        SQL);
        $this->addSql(<<<'SQL'
