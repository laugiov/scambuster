...
/**
 * Add HMAC chain columns to audit_log.
 *
...
final class Version2026041200100000 extends AbstractMigration
{
    ...
    {
        return 'Add prev_hmac + row_hmac columns to audit_log + backfill HMAC chain';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        if (!is_string($hexKey) || strlen($hexKey) !== 64 || !ctype_xdigit($hexKey)) {
            throw new \RuntimeException(
                'This migration requires AUDIT_HMAC_KEY env var (64 hex chars). '
