...
/**
 * Metrics harness for human-factor signals.
 *
...
#[AsCommand(
    ...
    description: 'Compute baseline metrics from annotations + judge + production CSVs',
)]
final class EvalComputeMetricsCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('test-set', null, InputOption::VALUE_REQUIRED, 'Test set CSV (production predictions)', '/app/var/eval/test-set.csv')
