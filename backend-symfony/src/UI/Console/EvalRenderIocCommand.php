...
/**
 * Spec 102 / Phase B / S1 — Render a single IOC + its 3-message
 * window in a human-readable format for annotation OR in JSON for
 * programmatic consumption by the judge harness (S2).
 *
...
#[AsCommand(
    ...
    description: 'Spec 102 — render one IOC + 3-msg window + production predictions for annotation/judging',
)]
