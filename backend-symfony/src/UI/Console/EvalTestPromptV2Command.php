...
/**
 * Spec 102 / Phase E / S5 — Prompt v2 intervention test.
 *
...
#[AsCommand(
    ...
    description: 'Spec 102 — run prompt v2 on a batch of IOCs (same model gpt-4o-mini)',
)]
final class EvalTestPromptV2Command extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title("Spec 102 — Prompt v2 run ({$model})");
