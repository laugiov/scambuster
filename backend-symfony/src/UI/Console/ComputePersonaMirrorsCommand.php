...
/**
 * Spec 104 P3 — Batch-generate the Cognitive Mirror cache.
 *
...
#[AsCommand(
    ...
    description: 'Spec 104 P3 — generate the Cognitive Mirror cache (one LLM call per persona x scam type pair)',
)]
final class ComputePersonaMirrorsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('Spec 104 P3 — Cognitive Mirror batch');
        $io->writeln(sprintf(
