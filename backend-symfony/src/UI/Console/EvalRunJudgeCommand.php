...
/**
 * Spec 102 / Phase B / S2 — Multi-judge harness for human-factor signals.
 *
...
#[AsCommand(
    ...
    description: 'Spec 102 — call gpt-4o (or gpt-4o-mini) on an IOC, save independent judgment as JSON',
)]
final class EvalRunJudgeCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title("Spec 102 — Judge run ({$model})");
