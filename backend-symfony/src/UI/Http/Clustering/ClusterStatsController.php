...
#[OA\Get(
    ...
    parameters: [
        new OA\Parameter(
            ...
            in: 'query',
            required: false,
            description: 'Optional scam type filter (cluster.primary_scam_types ANY match)',
        ...
        new OA\Parameter(
            ...
            in: 'query',
            required: false,
            description: 'Period restricts conversation counts (not cluster counts)',
