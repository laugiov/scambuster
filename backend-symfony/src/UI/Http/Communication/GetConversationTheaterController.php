 ...
 * consistent state. Each IOC carries its `revelation_context`, plus a
 * `human_factor` aggregate block.
 *
...
#[OA\Get(
    ...
    summary: 'Live Bait Theater composite payload (meta + messages + iocs)',
    tags: ['Conversations'],
    parameters: [
