    ...
    requestBody: new OA\RequestBody(
        ...
        content: new OA\JsonContent(
            ...
            properties: [
                ...
                new OA\Property(property: 'confidence_threshold', type: 'number', description: 'Minimum confidence threshold (0.0-1.0). Default lowered to 0.55 to accept hybrid scams.', default: 0.55, minimum: 0, maximum: 1),
            ]
        )
    ),
    responses: [
...
final readonly class AutoClassifyConversationController
{
    ...
    public function __invoke(string $convId, Request $request): JsonResponse
    {
        ...
        // Default lowered 0.75 → 0.55 to accept hybrid scams.
