...
#[OA\Post(
                ...
                new OA\Property(
                    ...
                    properties: [
                        ...
                        new OA\Property(
                            property: 'message-id',
                            type: 'string',
                            description: 'RFC822 Message-ID generated by Gmail (without angle brackets < >)',
    ...
    responses: [
        new OA\Response(response: 204, description: 'Marked as sent'),
        new OA\Response(
            response: 400,
            description: 'Error (already sent or invalid)',
...
final readonly class MarkReplySentController
{
    ...
    public function __invoke(string $msgId, Request $request): JsonResponse
    {
        ...
        try {
            ...
            // The duplicate /sent asserts a different
