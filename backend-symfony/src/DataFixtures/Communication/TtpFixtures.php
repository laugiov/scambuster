 ...
 *
 * Mirrors the canonical seed rows of the lkp_ttp migration; a consistency
 * test locks the two constants against each other so they can never drift.
 */
class TtpFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    /**
     * Canonical taxonomy seed rows, mirroring the lkp_ttp migration seeds.
     *
