...
class User implements UserInterface, PasswordAuthenticatedUserInterface, TwoFactorInterface
{
    ...
    // `tenant_id` column dropped. The previous `tenantId`
    // field was decoration only (random UUID per User, never filtered
    // by any repository). If a future change re-introduces real
    ...
    // totp_secret is transparently encrypted at rest via
