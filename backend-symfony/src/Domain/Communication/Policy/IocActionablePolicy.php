 ...
 *
 * Spec 111 — three different conversation-count surfaces (list, detail,
 * Theater) historically used three different exclusion lists, producing
 * three different numbers for the same conversation. This policy
 * unifies them.
 *
