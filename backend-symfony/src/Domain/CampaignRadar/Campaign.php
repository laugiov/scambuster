...
class Campaign
{
    ...
    /**
     * Stores the representative simhash hash for the campaign (centroid).
     * Used to compute similarity in clustering.
     */
    ...
    /**
     * Sets the centroid simhash hash (representative of the campaign).
     * Used to compute similarity during clustering.
     */
