...
final readonly class ValidationResult
{
    public function __construct(
        ...
        // Structured correction (problem_span / replacement /
    ...
    public static function fromLLMResponse(array $data, ?string $generatedText = null): self
    {
        ...
        // Parse optional structured correction.
     ...
     *
     * Extended with score fields (naturalness, persona_fit,
    ...
    public function toLegacyArray(): array
    {
        return [
            ...
            // Score fields exposed for audit_log persistence.
