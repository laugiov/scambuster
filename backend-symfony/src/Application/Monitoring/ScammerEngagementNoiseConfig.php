...
/**
 * Spec 096 / C1 — Noise patterns used to exclude technical artifacts
 ...
 *
 * TODO (spec 096 follow-up): consider merging the two registries once
 * the live filter is stable on all historical patterns. Requires
 * dedicated spec to avoid regressing the ingest pipeline.
 */
