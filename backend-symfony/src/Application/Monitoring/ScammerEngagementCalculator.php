...
/**
 * Bias-corrected scammer engagement rate.
 *
 ...
 *
 * TODO: persist outbound `external_message_id` at send
...
final readonly class ScammerEngagementCalculator
{
    ...
    /**
     * @param list<string>|null $honeypotEmailAddresses comma-decoded from env.
    ...
    public function calculate(
        ...
        // Period maps to a Postgres interval string. 'all' = no filter.
    ...
    private function runQuery(
        ...
        // Period filter scopes which conversations are
    ...
    /**
     * Map the period query param to a Postgres interval
