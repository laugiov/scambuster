...
class ConversationMetricsCollector
{
    ...
    /**
     * Counts the number of sensitive IOCs in a list of ObservedIoc.
     * Utility method to avoid logic duplication.
     *
     * The IOC type is extracted from the context JSON ('type' key).
     * Sensitive types: IBAN, phone, crypto_wallet, telegram_username, url
     *
     * @param array<ObservedIoc> $iocs List of IOCs
     *
     * @return int Number of sensitive IOCs
     */
