...
final class ThreatActorStixBuilder
{
    ...
    private const MITRE_TECHNIQUES = [
        ...
        // T1656 (Impersonation) added in MITRE ATT&CK v14 (Oct 2023).
    ...
    public function buildThreatActor(array $campaignData, ?array $actorProfile, array $metrics): array
    {
        ...
        $threatActor['extensions'] = [ScambusterStixExtensions::ACTOR_ID => ScambusterStixExtensions::wrap('x_scambuster_actor', $extension)];

        return $threatActor;
    }

    /**
     * Build a singleton threat-actor for a conversation
