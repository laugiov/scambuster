...
final readonly class ReplyValidator
{
    public function __construct(
        ...
        // When false, the validator ignores the $context
     ...
     * @param array<string, mixed>|null $context     Optional conversational
     *                                               context. When null or when
     ...
     *
     * Return array also includes score fields (naturalness,
    ...
    public function validateMultiCriteria(string $text, string $personaCode, ?array $context = null): ValidationResult
    {
        ...
        try {
            ...
            // Pass $text so StructuredCorrection can validate
