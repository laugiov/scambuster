...
final class IOCLikelihoodScorer
{
     ...
     *
     * Covers both EN and FR keywords. The FR-only list previously missed
     * scoring channels on the predominantly EN corpus.
     */
     ...
     *
     * Covers both EN and FR regex patterns.
     */
