...
final readonly class STIXExporter
{
    ...
    /**
     * Exports a campaign to STIX 2.1.
     *
    ...
    /**
     * Extracts IoCs from the campaign's profile YAML.
     *
    ...
    {
        // Priority: profileYaml (generated by LLM), fallback to notes
    ...
    /**
     * Returns an empty IoCs structure.
     *
     * @return array{domains: list<string>, emails: list<string>, urls: list<string>, phone_numbers: list<string>, ip_addresses: list<string>, file_hashes: list<string>}
     */
    ...
    /**
     * Validates that the profile has a minimal valid structure.
     *
    ...
    /**
     * Extracts domains with multiple fallbacks.
     *
     * @param array<string, mixed> $profile
     *
     * @return list<string>
    ...
    private function extractDomains(array $profile): array
    {
        ...
        // Path 2: variants.url_shapes (parsing)
    ...
    /**
     * Extracts emails with PII filtering.
     *
     * @param array<string, mixed> $profile
     *
     * @return list<string>
    ...
    private function extractEmails(array $profile): array
    {
        ...
        // Filter out personal emails (PII)
    ...
    /**
     * Checks if an email is a personal email (PII).
     */
    ...
    /**
     * Extracts URLs, filtering out placeholders.
     *
     * @param array<string, mixed> $profile
     *
     * @return list<string>
    ...
    private function extractUrls(array $profile): array
    {
        ...
        // Filter patterns (remove placeholders)
    ...
    /**
     * Validates that no PII is present in the bundle.
     *
     * @param array<string, mixed> $bundle
     *
     * @throws \RuntimeException if PII detected
     */
    private function validateNoPII(array $bundle): void
    {
        ...
        // PII patterns: personal emails only
        $patterns = [
