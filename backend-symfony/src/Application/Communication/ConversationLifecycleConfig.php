...
final class ConversationLifecycleConfig
{
    ...
    private const POLICIES = [
        ...
        // INVOICE_FRAUD and CEO_FRAUD allow reopen within 72h to recover
        // late scammer follow-ups (measured loss 21 % and 100 %
        // respectively over 30-day audit).
        ...
        // PHISHING/PHISH_*/TECH_SUPPORT allow reopen within 72h. Measured
        // loss before this: PHISHING 17 %, TECH_SUPPORT 33 %. Timeout stays
        // short to purge true hit-and-run, but late follow-ups can re-engage.
        ...
        // JOB_OFFER allows reopen (33 % loss measured).
        ...
        // Fallback — UNKNOWN inbound deserves reopen
