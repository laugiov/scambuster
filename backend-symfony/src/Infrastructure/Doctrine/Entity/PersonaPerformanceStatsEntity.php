 ...
 * because it contains Doctrine annotations (a violation of pure business logic).
 */
...
class PersonaPerformanceStatsEntity
{
    ...
    private string $rewardSum = '0.0000'; // Doctrine uses string for DECIMAL
     ...
     * Bridges from the Infrastructure world to the Domain world.
     */
    ...
    // Setters (for Doctrine hydration)
